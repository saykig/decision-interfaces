"""Fresh R14-to-R19A build and transitive axiom audit; cached dependencies are read-only."""
import argparse
import hashlib
import json
import os
...
ROOT = PHASE.parent / 'lean_belief_bridge_2026_09_19' / 'lean'
REVISION = '0df444a360eaa60ab8c11dca51a86af692955474'
TOOLCHAIN = 'leanprover/lean4:v4.33.1'
ALLOWED = {'propext', 'Classical.choice', 'Quot.sound'}
MODULES = ['Beliefs', 'Transcripts', 'Receiver', 'Continuation', 'Bridge', 'Kernel', 'Equilibrium']
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='di-r19a-proof-') as temp:
        build = Path(temp)
